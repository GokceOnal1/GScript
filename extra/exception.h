...
#define errGS109 "GS.109 - Importing entry is illegal"
#define errGS110 "GS.110 - Cannot import '%s' while within '%s'"
#define errGS111 "GS.111 - Type '%s' is not a list but precedes '->'"
